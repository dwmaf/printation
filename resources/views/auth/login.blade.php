        ...
        <div
            ...
            <div class="w-full md:w-1/2 p-8 md:p-12">
                ...
                <form action="{{ route('login') }}" method="POST" class="space-y-5">
                    ...
                    <button type="submit"
                        class="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3 rounded-xl transition-all shadow-lg shadow-blue-500/30 mt-4 cursor-pointer">
                        Masuk
                    </button>
                </form>
            </div>
            ...
            <div class="hidden md:flex w-full md:w-1/2 bg-[#015DB4] items-center justify-center p-10 relative">
                <div class="absolute bottom-0 left-0 w-full h-1/2 bg-linear-to-t from-blue-700/50 to-transparent"></div>
