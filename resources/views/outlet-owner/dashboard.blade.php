    ...
    <div class="flex p-6 gap-4 min-h-screen">
        <div class="bg-[#FAFAFA] rounded-xl flex flex-col w-[18%]">
            ...
            <div class="flex flex-col">
                <ul
                    class="flex gap-3 text-[#B1B0AB] cursor-pointer p-3 pl-6 w-full hover:bg-[#EFF6FF] hover:text-indigo-500 transition-colors">
                ...
                <div class="flex flex-col md:flex-row justify-between items-center mb-4 gap-4 bg-[#FAFAFA] p-6 rounded-xl">
                    ...
                    <div class="flex items-center gap-3 min-w-0">
                        <div class="p-3 bg-gray-100 rounded-full shrink-0">
                            <svg xmlns="http://www.w3.org/2000/svg" width="25px" height="25px" viewBox="0 0 24 24">
                                <path fill="#6155F5" fill-rule="evenodd"
            ...
            <div class="grid grid-cols-6 grid-rows-9 gap-4 bg-[#FAFAFA] p-6 rounded-xl flex-1">
                ...
                <div class="col-span-2 row-span-3 col-start-3 bg-white shadow-md rounded-xl p-6">
                    ...
                    <div class="flex gap-2">
                        ...
                        @else
                            <img src="{{ asset('images/trend-down.svg') }}" alt="">
                            <span
                                class="text-[#F93C65] font-bold">{{ number_format(abs($pagesPercentageChange), 0) }}%</span>
                            dari kemarin
                        @endif
                    </div>
                </div>
                <div class="col-span-2 row-span-3 col-start-5 bg-white shadow-md rounded-xl p-6 flex justify-between">
                    ...
                    <div class="p-2 bg-[#96befe] rounded-3xl h-fit">
                        <svg xmlns="http://www.w3.org/2000/svg" width="40px" height="40px" viewBox="0 0 24 24">
                            <g fill="none" stroke="#174fa8" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="2">
                ...
                <a href={{ route('outlet.payments') }}
                    ...
                    <span
                        ...
                        SEKARANG <svg xmlns="http://www.w3.org/2000/svg" transform="rotate(90)"" width="15px"
                ...
                <div
                    class="row-span-6 col-start-6 row-start-4 bg-white shadow-md rounded-xl p-6 flex flex-col items-center">
                    @if ($outlet->qris_path)
