            ...
            <div class="grid grid-cols-1 gap-4 max-h-[60vh] overflow-y-auto pr-2 custom-scrollbar">
                ...
                <div class="bg-gray-800 hover:bg-gray-600 border border-gray-700 p-5 rounded-xl flex justify-between items-center shadow-lg">
                    <div class="flex items-center space-x-4">
                        <div class="w-14 h-14 rounded-xl flex items-center justify-center text-lg font-bold shadow-inner
                            {{ $file->type == 'PDF' ? 'bg-red-600 text-white' : 'bg-blue-500 text-white' }}">
                            {{ $file->type }}
                        </div>
