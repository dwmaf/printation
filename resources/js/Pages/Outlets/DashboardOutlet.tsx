...
import { Printer, TrendingUp, TrendingDown, BarChart3, Store } from 'lucide-react';
...
export default function DashboardOutlet({ stats }: StatsProps) {
    ...
    const chartOptions = {
        ...
        colors: ['#059669'], // emerald color for outlet
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-6 gap-4">
                    ...
                    <div className="md:col-span-1 xl:col-span-2 shadow-md rounded-xl p-5 sm:p-6 flex flex-col justify-between bg-white relative overflow-hidden group hover:shadow-lg transition-all duration-300">
                        <div className="flex justify-between items-start z-10">
                            <div>
                                ...
                                <p className="font-medium text-xs text-gray-400">Bulan Ini (Outlet Anda)</p>
                            </div>
                            <div className="p-2 bg-emerald-100/50 rounded-2xl group-hover:scale-110 transition-transform">
                        ...
                        <div className="z-10">
                            <p className="text-3xl sm:text-4xl font-extrabold text-gray-800 mb-2 mt-2 leading-tight">
                                ...
                                <span className="block sm:inline sm:ml-1 text-lg text-gray-500 font-medium">Lembar</span>
                            </p>
                    ...
                    <div className="md:col-span-1 xl:col-span-2 shadow-md rounded-xl p-5 sm:p-6 flex flex-col justify-between bg-white relative overflow-hidden group hover:shadow-lg transition-all duration-300">
                        <div className="flex justify-between items-start z-10">
                            <div>
                                ...
                                <p className="font-medium text-xs text-gray-400">Sepanjang Masa (Outlet Anda)</p>
                            </div>
                        ...
                        <div className="z-10">
                            ...
                            <div className="flex items-center gap-2">
                                <span className="text-xs text-gray-400 font-medium italic">Akumulasi seluruh print outlet Anda</span>
                            </div>
                        </div>
                    ...
                    <div className="md:col-span-2 xl:col-span-4 bg-white shadow-md rounded-xl p-4 sm:p-6">
                        <div className="flex items-center gap-2 mb-6">
                            ...
                            <h3 className="font-bold text-gray-700">Statistik Pencetakan Outlet (6 Bulan Terakhir)</h3>
                        </div>
                        <Chart 
                            type="bar" 
                            height="280" 
