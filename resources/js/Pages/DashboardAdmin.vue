    ...
    <AdminLayout>
        ...
        <div class="h-full">
            <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-6 gap-4">
                ...
                <div
                    class="md:col-span-1 xl:col-span-2 shadow-md rounded-xl p-5 sm:p-6 flex flex-col justify-between bg-white relative overflow-hidden group hover:shadow-lg transition-all duration-300">
                    ...
                    <div class="z-10">
                        <p class="text-3xl sm:text-4xl font-extrabold text-gray-800 mb-2 mt-2 leading-tight">
                            <span>{{ stats.sheetsThisMonth }}</span>
                            <span class="block sm:inline sm:ml-1">Lembar</span>
                        </p>
                ...
                <!-- apex charts -->
                <div class="md:col-span-2 xl:col-span-4 bg-white shadow-md rounded-xl p-4 sm:p-6">
